...
# data
parser.add_argument('--dataset_name', type=str, default='asl')
parser.add_argument('--train_data_paths', type=str, default=r'data/asl-train.npz')
parser.add_argument('--valid_data_paths', type=str, default=r'data/asl-valid.npz')
parser.add_argument('--save_dir', type=str, default=r'checkpoints/asl_checkpoints')
parser.add_argument('--gen_frm_dir', type=str, default=r'results/asl_results')
...
def schedule_sampling(eta, itr):
    ...
    if args.total_length - args.input_length - 1 <= 0:
        raise ValueError("The total length minus input length minus 1 must be positive. Check args.total_length and args.input_length.")
...
def train_wrapper(model):
    ...
    for itr in range(1, args.max_iterations + 1):
        ...
        if itr % args.snapshot_interval == 0:
            print(f"Saving model at iteration {itr}")
            model.save(itr)
